An agile tool innovation project based on Antd+react+typescript. Read https://ant.design/docs/react/use-in-typescript for detail. Do remember update your yarn or npm to the latest version before you start.
